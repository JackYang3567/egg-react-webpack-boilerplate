...
class Home extends Component {
  static fetch() {
    return Promise.resolve({
      list: [{
        id: 0,
        title: 'Egg + React 服务端渲染模式',
        summary: '基于 Egg + React + Webpack 服务端渲染工程骨架项目',
        hits: 550,
        url: 'https://www.yuque.com/easy-team/egg-react/ssr'
      }, {
        id: 0,
        title: 'Egg + React 前端渲染模式',
        summary: '基于Egg + React + Webpack 前端工程骨架项目',
        hits: 550,
        url: 'https://www.yuque.com/easy-team/egg-react/client'
      }, {
        id: 1,
